...
{
    public class CollectionRepository : CaldavEntitiesRepository<CalendarCollection>,ICollectionRepository
    {
        public CollectionRepository(CalDavContext context):base(context)
        {
        }
