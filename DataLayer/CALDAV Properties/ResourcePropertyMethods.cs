...
//        // {
//        //     var property = string.IsNullOrEmpty(mainNs)?resource.Properties.SingleOrDefault(p => p.Name == propertyName) : resource.Properties.SingleOrDefault(p => p.Name == propertyName && p.Namespace == mainNs);
...
//        public static bool CreateOrModifyPropertyAdmin(this CalendarResource resource, string propertyName, string nameSpace,
//            string propertyValue, Stack<string> errorStack)
//        {
//            //get the property
//            var property =
